  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      <motion.p
        ...
        className='mt-[8px] font-nomral sm:text-[32px] text-[20px] text-center text-secondary-white'
      >
       <span className='font-extrabold text-white'> Metaverse </span>
        
        is a new thing in the future, where you can enjoy the virtual world by feeling like it's really real, you can feel what you feel in this metaverse world, because this is really 
